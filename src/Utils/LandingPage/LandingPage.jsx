        ...
        <>
            <div className="landing-page-div">
                <div>
                    ...
                    <h1><span>half of marketers</span> haven't yet!</h1>
                </div>
            </div>
            <div className="landing-page-div2">
                <div><h3>Media+</h3></div> {/* Media stays fixed */}
                <div>=</div>
                <div className="animation-wrapper"> {/* Fixed height container */}
                    <div className={`animation-text ${isAnimating ? "slide-out" : "slide-in"}`}>
                       <h2> {words[currentIndex]}</h2>
                    </div>
                </div>
            </div>
            <p class="netflix-para">Netflix-style video discovery for your prospects that turns viewers into customers</p>
